...
def test():
    ...
    for i in range(0, len(beiceping_id)):
        ...
        each_obj = jggbTongji.objects.filter(beiceping=each_beiceping_id, giveup=0)  # 得到这个被测评人在统计表中的所有数据
        print(len(each_obj))
...
if __name__ == '__main__':
    ...
    django.setup()
    from Fangan.models import jggbTongji, xygbIndexWeight, GbCpWeight, xygbTongji, jggbIndexWeight
